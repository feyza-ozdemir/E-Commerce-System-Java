...
public class Test {
    public static void main(String[] args){
        ...
        CreditCard c2 = new CreditCard("2222222222222222", "Melda Gungor", "777", "12/30");
        ...
        Product p1 = new Product("Old Season T-Shirt", "Yellow", "T-Shirt", "S", 10, 5.1, "It has a soft fabric and is oversize.", 699.99);
        Product p2 = new Product("New Season T-Shirt", "Yellow", "T-Shirt", "M", 10, 6.1, "It has a stiff fabric and wraps the body.", 599.99);
